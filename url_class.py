...
# TODO Determine if I need to integrate it with any other classes, or if it is fine how it is
# TODO Integrate this with the Scorelist class and Group class
...
class URL:
    def __init__(self, domain, subdomain, filepath=None, urlparams=None):
        ...
        if filepath is not None:
            ...
            self.path = None
        # TODO Add in way to seperate the file type from the path
